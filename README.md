...
To install this user script, simply navigate to [this link](https://github.com/Starbucksbot/bptf-bot-utilities/blob/master/bptf-bot-utilities.user.js) and click "Install".
